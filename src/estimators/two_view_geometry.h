...
#ifndef BKMAP_TWO_VIEW_GEOMETRY_H
#define BKMAP_TWO_VIEW_GEOMETRY_H
...
EIGEN_DEFINE_STL_VECTOR_SPECIALIZATION_CUSTOM(bkmap::TwoViewGeometry)

#endif //BKMAP_TWO_VIEW_GEOMETRY_H
