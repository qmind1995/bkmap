...
#ifndef BKMAP_GENERALIZED_RELATIVE_POSE_H
#define BKMAP_GENERALIZED_RELATIVE_POSE_H
...
EIGEN_DEFINE_STL_VECTOR_SPECIALIZATION_CUSTOM(bkmap::GR6PEstimator::X_t)

#endif //BKMAP_GENERALIZED_RELATIVE_POSE_H
