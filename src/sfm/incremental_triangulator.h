...
#ifndef BKMAP_INCREMENTAL_TRIANGULATOR_H
#define BKMAP_INCREMENTAL_TRIANGULATOR_H
...
EIGEN_DEFINE_STL_VECTOR_SPECIALIZATION_CUSTOM(
        bkmap::IncrementalTriangulator::CorrData)


#endif //BKMAP_INCREMENTAL_TRIANGULATOR_H
